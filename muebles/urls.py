...
from .views import HomeView, ComedoresTemplateDetailView, CocinasTemplateDetailView, ClosetsTemplateDetailView, \
    PuertasTemplateDetailView, BanosTemplateDetailView
